...
export function MarkdownPreview({
  ...
  const shouldHideScrollbar = Boolean(
    scrollClassName?.split(/\s+/).includes("scrollbar-hidden")
  )
  ...
  return (
    <div className={cn("h-full", className)}>
      <ScrollFadeEffect
        ...
        className={cn(
          "markdown-preview-surface h-full px-4 py-4 sm:px-5",
          shouldHideScrollbar ? "scrollbar-hidden" : "scrollbar-subtle",
          scrollClassName
        )}
      >
